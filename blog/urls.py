...
urlpatterns = [
    ...
    path('article/<str:article>', views.SingleArticleAPIView.as_view(), name='single_article'),
    path('article/search/<str:query>', views.SearchArticleAPIView.as_view(), name='search_article'),
